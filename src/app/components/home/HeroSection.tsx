...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#c7dbea] via-[#bdd4e6] to-[#b4cde0] border-t-4 border-[#2d96d8] rounded-t-[22px] pt-3 pb-5 lg:pb-7 min-h-[calc(100vh-120px)] flex items-start">
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          className="absolute -top-28 -left-20 h-80 w-80 rounded-full bg-[#0a1247]/10 blur-3xl"
          animate={{ x: [0, 40, 0], y: [0, 30, 0] }}
          transition={{ duration: 14, repeat: Infinity, ease: 'easeInOut' }}
        />
        <motion.div
          className="absolute -bottom-24 -right-12 h-96 w-96 rounded-full bg-[#2f77b7]/12 blur-3xl"
          animate={{ x: [0, -45, 0], y: [0, -25, 0] }}
          transition={{ duration: 16, repeat: Infinity, ease: 'easeInOut' }}
        />
        <motion.div
          className="absolute top-1/3 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full border border-[#0a1247]/15"
        ...
        <div className="absolute inset-0 overflow-hidden opacity-[0.035]">
          <motion.div
            className="absolute top-[14%] left-0 whitespace-nowrap text-[100px] font-black tracking-[0.2em] text-[#0a1247]"
            animate={{ x: ['-100%', '100%'] }}
          ...
          <motion.div
            className="absolute top-[62%] right-0 whitespace-nowrap text-[90px] font-black tracking-[0.18em] text-[#0a1247]"
            animate={{ x: ['100%', '-100%'] }}
        ...
        <motion.div
          className="absolute top-[24%] right-[8%] text-[44px] lg:text-[64px] font-extrabold text-[#0a1247]/[0.04] leading-none"
          animate={{ y: [0, 10, 0] }}
        ...
        <motion.div
          className="absolute bottom-[18%] left-[5%] text-[28px] lg:text-[40px] font-extrabold text-[#0a1247]/[0.04] leading-none"
          animate={{ y: [0, -10, 0] }}
      ...
      <div className="max-w-[1500px] mx-auto px-4 lg:px-6 relative z-10 w-full">
        <div className="mx-auto max-w-[1160px] flex flex-col items-center text-center">
          <motion.div
            initial={{ opacity: 0, y: 34 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: 'easeOut' }}
            className="font-sans text-gray-900 space-y-2 lg:space-y-3 mb-3 lg:mb-4"
          >
            <motion.h1
              className="text-[1.7rem] sm:text-[1.95rem] lg:text-[2.6rem] font-bold text-[#0a1247] tracking-[0.01em] leading-[1.05]"
            ...
            <motion.h2
              className="text-[1.15rem] sm:text-[1.35rem] lg:text-[1.85rem] leading-[1.12] text-[#0a1247] font-medium tracking-[0.002em]"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <div className="w-[175px] h-[3px] bg-[#0a1247] mx-auto rounded-full mt-1 mb-1" />

            <motion.p
              className="text-[0.92rem] sm:text-[1.02rem] lg:text-[1.25rem] text-[#203247] max-w-4xl leading-[1.3] font-medium mx-auto"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            ...
            className="relative w-full mt-3 lg:mt-4"
          >
            <div className="absolute -inset-2 rounded-[28px] bg-gradient-to-r from-white/50 via-[#cce2f2]/30 to-white/50 blur-xl" />
            <div className="relative grid grid-cols-1 md:grid-cols-3 gap-2.5 lg:gap-3.5 max-w-[90vw] lg:max-w-[760px] mx-auto items-stretch">
