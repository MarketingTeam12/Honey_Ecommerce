        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mt-12">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6">
              <h3 className="text-lg mb-4 text-green-800">✅ Correct Flow</h3>
            ...
            <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
              <h3 className="text-lg mb-4 text-red-800">❌ What NOT to Do</h3>
              <ul className="space-y-2 text-gray-700">
                <li>• Add to Cart → Direct Payment ❌</li>
                <li>• Skip Cart Page ❌</li>
                <li>• Skip Address Step ❌</li>
                <li>• Skip Review Step ❌</li>
                <li>• Direct checkout without cart ❌</li>
              </ul>
            </div>
          </div>
        </div>
